...
public class Constants {
     ...
     */
    public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList("AU", "NZ");
     ...
     */
    public static final String PAYMENT_GATEWAY_TOKENIZATION_NAME = "eway";
